...
public class EmployeesListEdit extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException  {
        ...
        toClient.println(Utils.header("Employees list. Servlet developed by #your name#"));
        ...
        for(int i=0; i< employeesList.size(); i++){
                ...
                toClient.println("<td><a href='EditName?id=" + employee.employeeId + "'>Edit Employee</a></td>");
                toClient.println("</tr>");
        }
