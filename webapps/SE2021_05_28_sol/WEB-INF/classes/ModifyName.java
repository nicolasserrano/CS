...
public class ModifyName extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException  {
        ...
        EmployeesDataBase employee = new EmployeesDataBase(
            ...
            lastNameStr,
            firstNameStr,
            Integer.parseInt(extensionStr),
            null
        );
        int n = EmployeesDataBase.updateEmployeeName(connection, employee);
		
		res.setContentType("text/html");
        out.println("employeeId: " + employeeIdStr + " first name: " + firstNameStr + " last name: " + lastNameStr
          + " extension: " + extensionStr + " at " + java.time.LocalDateTime.now() + " updated: " + n);
    }
}
