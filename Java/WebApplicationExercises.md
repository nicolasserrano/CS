...
7. Create the servlet ProductEditMockup that reads an argument with the identifier of a product an returns a form with the data for that product. This data can be edited by the user. The modified data will be sent to the servlet ProductSave (it is not neccesary to create this servelt at this moment). The servlet will appear as:
